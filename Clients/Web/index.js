document.onreadystatechange = function (event) {
    ...
    (function Main(sampleCode) {
        ...
        "            class member variable set : this x x",
        "            class member variable set : this y y",
        ...
        "            function return : { class member variable get : this x}",
        "        class member function end",
        "        ",
        "        class member function start : Point public getY int",
        "            function return : { class member variable get : this y}",
        "        class member function end",
        "        ",
        "        class member function start : Point public getManhattanTotal int",
        "            function return : { operation : { class member variable get : this x } plus { class member variable get : this y } }",
        "        class member function end",
        "    class end",
        "    ",
        ...
        "            class member variable set : this label label",
        "        class constructor end",
        "        ",
        ...
        "            function return : { class member variable get : this label }",
        "        class member function end",
        "    class end",
        "    ",
        "    comment line : Main",
        ...
        "        if start : { not : { value : true } }",
        "            print line : (\"Hi!\")",
        "        if end",
        "        if start : d",
        "            print line : (\"d is true!\")",
        "        if end",
        "        if start : { operation : c lessthan 14 }",
        ...
        "        variable declare incomplete : i {dictionary type : string int } { dictionary initialize start : string boolean }",
        ...
        "        variable declare : j Point { class new : Point 3 7 }",
        "        class member function call : k setX 4",
        "        print line : { class member function call : j getManhattanTotal }",
        "        ",
        "        comment line : (Templated Class Usage)",
        "        variable declare : l PointLabeled<string> { class new : PointLabeled<string> 0 0 \"origin\" }",
        "    main end",
        "file end",
        "",
        "comment line : (fin)"
